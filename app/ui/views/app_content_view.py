from PySide6.QtWidgets import QWidget, QVBoxLayout, QTabWidget, QHBoxLayout, QPushButton, QScrollArea
...
class AppContentView(QWidget):
    def __init__(self):
        ...
        self.notification_list_scroll_area.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
    ...
    def _open_feedback_link(self):
        QDesktopServices.openUrl(QUrl("https://github.com/neoapps-dev/airsync-qt/issues/new/choose"))